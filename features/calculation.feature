  ...
  Scenario: Energy calculation for single house with changes in isolation layers
    ...
    Given I go to "/"
     ...
     Then I should see "Ściany zewnętrzne"
      ...
      And I press "Dalej"
      And I select "yes" from "calculation[has_top_isolation]"
      And I select "yes" from "calculation[has_bottom_isolation]"
      And I press "Dalej"
      And I press "Wynik"
      And I should see "16kW to niezbędna moc grzewcza (C.O. bez CWU)"
  ...
  Scenario: Energy calculation for apartment
    ...
    Given I go to "/"
     ...
     Then I should see "Sąsiedztwo"
      And I check "calculation[has_top_isolation]"
      And I check "calculation[has_bottom_isolation]"
     ...
     Then I should see "A.D. gdzieś przed II wojną, 40m2 ogrzewane, Otwock i okolice"
      ...
      And I should see "Podłoga, Styropian twardy (XPS) 10cm"
      And I should see "9kW to niezbędna moc grzewcza (C.O. bez CWU)"
